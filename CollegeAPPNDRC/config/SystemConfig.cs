...
namespace CollegeAPP.config
{
	public static class SystemConfig
	{
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable IniConfig()
        {
            DataTable dtConfig = new DataTable();
            MySqlConnection M_Conn = new MySqlConnection(System.Configuration.ConfigurationManager.AppSettings["OLEDB_connString"].ToString());
            try
            {
                string strSql = " SELECT CLASS,KEY_NAME,KEY_VALUE,MEMO,VISIBLE FROM SYS_CONFIG ";
        ...
        /// <returns></returns>
        public static string UpdateConfig(ArrayList alConfig)
        {
            string strReturn = "";
            ...
            try
            {
                ...
                for (int i = 0; i < alConfig.Count; i++)
                {
                    ...
                    M_Comm.Parameters.Add(new MySqlParameter("@KEY_VALUE", MySqlDbType.LongVarChar));
        ...
        //通过名称得到某条配置信息值
        public static string GetValue(string strKEY_NAME)
        {
            string strReturn = "";
