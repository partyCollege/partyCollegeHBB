    ...
    public sealed class DES
    {
        ...
        public static string DESDeCode(string pToDecrypt, string sKey)
        {
            ...
            try
            {
                ...
                StringBuilder ret = new StringBuilder();
                return System.Web.HttpUtility.UrlDecode(System.Text.Encoding.GetEncoding("UTF-8").GetString(ms.ToArray()));
            }
            catch { return ""; };
        }
        #endregion
