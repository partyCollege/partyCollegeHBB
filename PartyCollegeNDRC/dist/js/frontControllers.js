...
app.controller("myoptioncourseController", ['$scope', '$location', '$rootScope', '$interval', 'getDataSource', 'FilesService', 'CommonService',
	function ($scope, $location, $rootScope, $interval, getDataSource, FilesService, CommonService) {

}]);
app.controller("myrequirecourseController", ['$scope', '$location', '$rootScope', '$interval', 'getDataSource', 'FilesService', 'CommonService',
	function ($scope, $location, $rootScope, $interval, getDataSource, FilesService, CommonService) {
}]);
