	...
	, function ($scope, $rootScope, $modal, $timeout, $stateParams, notify, $state, getDataSource, Base64) {
		...
		$scope.gridOptions = {
			...
			columnDefs: [
              ...
              { name: '所属类别', field: "departmentname", width: '20%', cellClass: "mycenter", headerCellClass: 'mycenter' },
              //{ name: '激活状态', field: "signstatus", width: '10%', cellClass: "mycenter", headerCellClass: 'mycenter', cellFilter: "activeStatus" },
              { name: '状态', field: "status", width: '10%', cellClass: "mycenter", headerCellClass: 'mycenter', cellFilter: "lockStatus" }
			],
