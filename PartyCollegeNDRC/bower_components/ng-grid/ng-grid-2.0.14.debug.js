...
window.ngGrid.i18n['en'] = {
    ...
    ngTotalItemsLabel: '总记录数:',
    ngSelectedItemsLabel: '所选项数:',
    ngPageSizeLabel: '每页条数:',
    ngPagerFirstTitle: '第一页',
    ngPagerNextTitle: '下一页',
    ngPagerPrevTitle: '上一页',
    ngPagerLastTitle: '最后一页'
};
...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "\n" +
    "            <select style=\"float: left;height: 20px; width: 70px\" ng-model=\"pagingOptions.pageSize\" >\r" +
    "\n" +
    ...
    "\n" +
    "            <input class=\"ngPagerCurrent\" min=\"1\" max=\"{{currentMaxPages}}\" type=\"number\" style=\"width:40px; height: 20px; margin-top: 1px; padding: 0 4px;\" ng-model=\"pagingOptions.currentPage\"/>\r" +
    "\n" +
    "            <span class=\"ngGridMaxPagesNumber\" ng-show=\"maxPages() > 0\" style=\"display: inline-block; vertical-align: top; padding-top: 4px;\" >/ {{maxPages()}}</span>\r" +
    "\n" +
