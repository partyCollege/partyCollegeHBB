...
app.run(['$http', '$rootScope', "SessionService", function ($http, $rootScope, SessionService) {
	...
	$rootScope.myStudyLinks = [
         { id: "1001", title: "最近学习", sref: "main.recentlearning", icon: "tubiaoicon-45", isSelected: false, isShow: true, childMenus: ["recentlearning"] },
         { id: "1002", title: "我的必修课", sref: "main.myrequirecourse", icon: "tubiaoicon-53", isSelected: false, isShow: true, childMenus: ["myrequirecourse"] },
         { id: "1003", title: "我的选修课", sref: "main.studycenter", icon: "tubiaoicon-10", isSelected: false, isShow: true, childMenus: ["studycenter"] },
         { id: "1004", title: "所有课程", sref: "main.allcourse({param:0})", icon: "tubiaoicon-33", isSelected: false, isShow: true, childMenus: ["allcourse", "courseinfo"] },
         { id: "1005", title: "学习档案", sref: "main.studytotal({no:0})", icon: "tubiaoicon-52", isSelected: false, isShow: true, childMenus: ["archives", "studytotal", "train"] }
