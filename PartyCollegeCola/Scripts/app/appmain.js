...
app.run(['$http', "$state", '$rootScope', 'SessionService', function ($http, $state, $rootScope, SessionService) {
    ...
    $rootScope.mainConfig = [
            ...
            { "title": "培训通知", "rounteName": "main.allcourse", "routeparam": null, "elementName": "allcourse", "childMenus": ["allcourse"], "select": false },
            { "title": "学员手册", "rounteName": "main.allcourse", "routeparam": null, "elementName": "allcourse", "childMenus": ["allcourse"], "select": false },
