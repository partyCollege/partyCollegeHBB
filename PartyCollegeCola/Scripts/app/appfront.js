...
app.run(['$http', '$rootScope', "SessionService", function ($http, $rootScope, SessionService) {
    ...
    $rootScope.myStudyLinks = [
         { id: "1001", title: "我的选修课", sref: "main.studycenter", icon: "tubiaoicon-50", isSelected: false, isShow: true, childMenus: ["studycenter"] },
         { id: "1005", title: "我的学习班", sref: "main.myclasslist", icon: "tubiaoicon-53", isSelected: false, isShow: true, childMenus: ["myclasslist", "myclass"] },
         { id: "1002", title: "选课中心", sref: "main.allcourse({param:0})", icon: "tubiaoicon-50", isSelected: false, isShow: true, childMenus: ["allcourse", "courseinfo"] },
